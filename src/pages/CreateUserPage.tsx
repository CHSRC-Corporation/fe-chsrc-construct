...
export function CreateUserPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // O back-end retorna token + usuário, então já autenticamos e seguimos
      // para a home. (Se o cadastro não devolver token, troque por navigate('/').)
      signIn(auth);
    ...
    <section className="auth">
      <header className="auth__hero">
        ...
        <p className="auth__hero-text">
          Crie sua conta gratuita e tenha acesso a todas as aulas, do canteiro
          de obras ao cálculo estrutural.
        </p>
